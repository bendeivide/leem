...
# Low-level Shiny GUI function for the leem package.
# Generates the Normal Distribution interface associated with
# P(X > q) (lower.tail = FALSE) using gui = "shiny"
# ===> This is the interface reference! <===
.shinyplotleemltfnormal <- function(q, mu, sigma, rounding,
                                    minimo, maximo, dec,
                                    long.segment, col,
                                    col2, lty, main,
                                    text.size, cex.main,
...
# Low-level Shiny GUI function for the leem package.
# Generates the Normal Distribution interface associated with
# f_X(X = q) (lower.tail = NULL) using gui = "shiny"
.shinyplotleemltnnormal <- function(q, mu, sigma, rounding,
                                    minimo, maximo, dec,
                                    long.segment, col,
                                    col2, lty, main,
                                    text.size, cex.main,
...
# ===> This is the interface reference! <===
.shinyplotleemranormal <- function(q1, q2, q, mu, sigma, rounding,
                                    minimo, maximo, dec,
                                    long.segment, col,
                                    col2, lty, main,
                                    text.size, cex.main,
  ...
  # Central plotting function
  # =========================
  make_plot <- function(q1, q2, q, mu, sigma, text.size, titorient, lsegment, comma) {
...
# Low-level Shiny GUI function for the leem package.
# Generates the Normal Distribution interface associated with
# P(a < X < b) (Region B) using gui = "shiny"
# ===> This is the interface reference! <===
.shinyplotleemrbnormal <- function(q1, q2, q, mu, sigma, rounding,
                                   minimo, maximo, dec,
                                   long.segment, col,
                                   col2, lty, main,
                                   text.size, cex.main,
