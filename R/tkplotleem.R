...
# Low-level Tcl/Tk GUI function for the leem package.
# Generates the Normal Distribution interface associated with
# f_X(X = q) (lower.tail = NULL) using gui = "tcltk"
.tkplotleemltnnormal <- function(
    q, mu, sigma, rounding,
    minimo, maximo, dec,
    long.segment, col,
    col2, lty, main,
...
# Low-level Tcl/Tk GUI function for the leem package.
# Generates the Normal Distribution interface associated with
# P(a < X < b) (Region B) using gui = "tcltk"
.tkplotleemrbnormal <- function(q1, q2, q, mu, sigma, rounding,
                                minimo, maximo, dec,
                                long.segment, col,
                                col2, lty, main,
                                text.size, cex.main,
