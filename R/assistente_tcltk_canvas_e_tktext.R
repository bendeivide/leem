...
#     code_text <- tktext(code_frame, height = 12, width = 90, wrap = "word",
#                         bg = "#f5f5f5", fg = "black",
...
#     tktag.configure(code_text, "comment", foreground = "#808080", font = tkfont.create(slant = "italic"))
#
#     # Make read-only
...
#
#     # Add the code block
#     add_code_block(code, is_user = FALSE)
#
#     # Add the run button
